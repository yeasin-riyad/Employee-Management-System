...
import EmployeeSalaryDisplayTable from './EmployeeSalaryDisplayTable'
...
const EmployeeSalary = () => {
    ...
    useEffect(()=>{
        const getEmpSalary= async()=>{
            try{
                const empSalary=await axiosSecure.get(`salary/getMy-salary`)
  ...
  return (
    <div className='mt-10 p-5'>
      ...
      <div className='mt-5'>
      <EmployeeSalaryDisplayTable salary={salary}/>
      </div>
    </div>
  )
}
